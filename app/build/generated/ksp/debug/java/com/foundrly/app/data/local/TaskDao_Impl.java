...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntity = new EntityInsertionAdapter<TaskEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`isCompleted`,`orderIndex`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfTaskEntity = new EntityDeletionOrUpdateAdapter<TaskEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`isCompleted` = ?,`orderIndex` = ? WHERE `id` = ?";
      }
  ...
  public Flow<List<TaskEntity>> getAllTasks() {
    final String _sql = "SELECT * FROM tasks ORDER BY orderIndex ASC";
      ...
      public List<TaskEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TaskEntity(_tmpId,_tmpTitle,_tmpIsCompleted,_tmpOrderIndex);
            _result.add(_item);
          }
          return _result;
        } finally {
